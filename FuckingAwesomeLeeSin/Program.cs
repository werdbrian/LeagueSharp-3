...
namespace FuckingAwesomeLeeSin
{
    class Program
    {
        ...
        static void Drawing_OnDraw(EventArgs args)
        {
            ...
            if (clicksecEnabled)
            {
                Render.Circle.DrawCircle(insecClickPos, 100, System.Drawing.Color.White);
            }
            ...
            if (newTarget != null && newTarget.IsVisible && Player.Distance(newTarget) < 3000 && paramBool("insecDraw"))
            {
                ...
                Render.Circle.DrawCircle(getInsecPos(newTarget), 100, System.Drawing.Color.White);
            }
            ...
            {
                Render.Circle.DrawCircle(Player.Position, 700, System.Drawing.Color.White);
            }
            if (Menu.Item("wjump").GetValue<KeyBind>().Active && paramBool("WJDraw"))
            {
                Render.Circle.DrawCircle(JumpPos.To3D(), 20, System.Drawing.Color.Red);
                Render.Circle.DrawCircle(Player.Position, 600, System.Drawing.Color.Red);
            }
            if (paramBool("drawQ")) Render.Circle.DrawCircle(Player.Position, Q.Range - 80, Q.IsReady() ? System.Drawing.Color.LightSkyBlue : System.Drawing.Color.Tomato);
            if (paramBool("drawW")) Render.Circle.DrawCircle(Player.Position, W.Range - 80, W.IsReady() ? System.Drawing.Color.LightSkyBlue : System.Drawing.Color.Tomato);
            if (paramBool("drawE")) Render.Circle.DrawCircle(Player.Position, E.Range - 80, E.IsReady() ? System.Drawing.Color.LightSkyBlue : System.Drawing.Color.Tomato);
            if (paramBool("drawR")) Render.Circle.DrawCircle(Player.Position, R.Range - 80, R.IsReady() ? System.Drawing.Color.LightSkyBlue : System.Drawing.Color.Tomato);
